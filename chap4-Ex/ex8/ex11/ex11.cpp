 ...
 * (so that if the vector is called primes, primes[0]==2, primes[1]==3, 
 * primes[2]==5, etc.). 

 * Then write a loop that goes from 1 to 100, checks each number to see 
 * if it is a prime, and stores each prime found in a vector. 
 * Write another loop that lists the primes you found. 
 * You might check your result by comparing your vector of prime numbers 
